                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="room-details-content">
                                ...
                                <div class="room-details-item">
                                    <span><img src="assets/service-2.png" alt=""> {{$room->bed}}</span>
                                    <span><img src="assets/icon-1.png" alt=""> {{$room->size}} SQFT</span>
                                    <span><img src="assets/icon-2.png" alt=""> {{$room->bath}} Bathroom</span>
                            ...
                            <div class="room-details-sidebar">
                                <div class="room-details-sidebar-form">
                                    <div class="room-sidebar-title">
                                        <span>Booking</span>
                                        <p>${{$room->price}}<span class="two">/NIGHT</span></p>
                                    </div>
                                ...
                                <div class="room-details-amenities">
                                    ...
                                    <div class="room-amenities-item">
                                        <ul>
                                            ...
                                            <li><img src="assets/icon-1.png" alt="">{{$room->size}} SQFT Rooms</li>
