        ...
        <div class="page-header">
            <div class="container-fluid">
                <div class="add_section">
                    ...
                    <form class="add_image" action="{{url('update_gallery')}}" method="Post"
                    ...
                    <div class="view_image">
                        @foreach ($food_gallery as $food_gallery)
                            <div class="image-container">
                                <img src="/food_gallery/{{ $food_gallery->image }}" alt="">
                                <h1>{{ $food_gallery->food_title}}</h1>
                                <h2>{{ $food_gallery->food_description}}</h2>
                                <a onclick="return confirm ('Are sure to delete this');"
                        href="{{url('delete_food_image', $food_gallery ->id)}}" class="btn btn-danger">Delete</a>
                            </div>
                        @endforeach
                    </div>
                </div>
