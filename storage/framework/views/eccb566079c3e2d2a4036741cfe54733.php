                    ...
                    <div class="col-lg-12">
                        <div class="hero-content text-center">
                            ...
                            <div class="hero-button">
                                <a href="">Book A Table <i class="fi fi-ts-arrow-right"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-6  upper">
                    <div class="section-title">
                        ...
                        <div class="hero-button">
                            <a href="#menu">Expore Our Restaurant<i class="fi fi-ts-arrow-right"></i></a>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-lg-6">
                        <div class="offer-details">
                            ...
                            <div class="offer-button">
                                <a href="#menu">Oder Now<i class="fi fi-ts-arrow-right"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-lg-12 text-center">
                        <div class="nav nav-tabs menu-nav style-three" id="nav-tab" role="tablist">
                            ...
                            <button class="nav-link" id="nav-beverages" data-bs-toggle="tab" data-bs-target="#tab4"
                                type="button" role="tab" aria-controls="tab4" aria-selected="true">
                                Beverage
                            </button>
                        </div>
                    </div>
                                ...
                                <div class="row">
                                    <div class="col-xl-4 col-lg-6 col-md-6 mt-30">
                                        <div class="food-menu-style">
                                            <div class="thumb">
                                                <img src="assets/dish-1.jpg" alt="Image Not Found">
                                                <div class="d-flex">
                                            ...
                                            <div class="info">
                                                <h4><a href="#">Steak with Side Salad</a></h4>
                                                <ul>
                                                    <li>Beef</li>
                                                    <li>Chili sauce</li>
                                                    <li>Soft Drinks</li>
                                    ...
                                    <div class="col-xl-4 col-lg-6 col-md-6 mt-30">
                                        <div class="food-menu-style">
                                            <div class="thumb">
                                                <img src="assets/dish-2.jpg" alt="Image Not Found">
                                                <div class="d-flex">
                                                    <div class="food-review">
                                                        <i class="fas fa-star"></i>
                                                        <span>4.2(3.1K)</span>
                                    ...
                                    <div class="col-xl-4 col-lg-6 col-md-6 mt-30">
                                        <div class="food-menu-style">
                                            <div class="thumb">
                                                <img src="assets/dish-3.jpg" alt="Image Not Found">
                                                <div class="d-flex">
                                                    <div class="food-review">
                                                        <i class="fas fa-star"></i>
                                                        <span>4.8(6.7K)</span>
                                            ...
                                            <div class="info">
                                                <h4><a href="#">Pizza with Cheese and pepperoni</a></h4>
                                                <ul>
                                                    <li>Cheese</li>
                                                    <li>Chili sauce</li>
                                                    <li>Soft Drinks</li>
                                    ...
                                    <div class="col-xl-4 col-lg-6 col-md-6 mt-30">
                                        <div class="food-menu-style">
                                            <div class="thumb">
                                                <img src="assets/dish-4.jpg" alt="Image Not Found">
                                                <div class="d-flex">
                                                    <div class="food-review">
                                                        <i class="fas fa-star"></i>
                                                        <span>5.0(3.5K)</span>
                                            ...
                                            <div class="info">
                                                <h4><a href="#">Broken Lasagna &amp; Parmesan</a></h4>
                                                <ul>
                                    ...
                                    <div class="col-xl-4 col-lg-6 col-md-6 mt-30">
                                        <div class="food-menu-style">
                                            <div class="thumb">
                                                <img src="assets/dish-5.jpg" alt="Image Not Found">
                                                <div class="d-flex">
                                                    <div class="food-review">
                                                        <i class="fas fa-star"></i>
                                                        <span>4.6(5.7K)</span>
                                            ...
                                            <div class="info">
                                                <h4><a href="#">Toast with Sunny Side Egg</a></h4>
                                                <ul>
                                    ...
                                    <div class="col-xl-4 col-lg-6 col-md-6 mt-30">
                                        <div class="food-menu-style">
                                            <div class="thumb">
                                                <img src="assets/dish-6.jpg" alt="Image Not Found">
                                                <div class="d-flex">
                                                    <div class="food-review">
                                                        <i class="fas fa-star"></i>
                                                        <span>4.8(5.5K)</span>
                                            ...
                                            <div class="info">
                                                <h4><a href="#">Double-Stack Mushroom</a></h4>
                                                <ul>
                                                    <li>4 chicken legs</li>
                                                    <li>Chili sauce</li>
                                                    <li>Soft Drinks</li>
                            ...
                            <div class="tab-pane fade" id="tab2" role="tabpanel" aria-labelledby="nav-id-2">
                                <div class="row">
                                    <div class="col-xl-4 col-lg-6 col-md-6 mt-30">
                                        <div class="food-menu-style">
                                            <div class="thumb">
                                                <img src="assets/dessert-1.jpg" alt="Image Not Found">
                                                <div class="d-flex">
                                                    <div class="food-review">
                                                        <i class="fas fa-star"></i>
                                                        <span>4.9(5.7K)</span>
                                            ...
                                            <div class="info">
                                                <h4><a href="#">Mixed Berry Cake</a></h4>
                                                <ul>
                                                    <li>Blueberry</li>
                                                    <li>Strawberry</li>
                                                    <li>Blackberry</li>
                                    ...
                                    <div class="col-xl-4 col-lg-6 col-md-6 mt-30">
                                        <div class="food-menu-style">
                                            <div class="thumb">
                                                <img src="assets/dessert-2.jpg" alt="Image Not Found">
                                                <div class="d-flex">
                                                    <div class="food-review">
                                                        <i class="fas fa-star"></i>
                                                        <span>4.2(3.1K)</span>
                                            ...
                                            <div class="info">
                                                <h4><a href="#">Pancakes with Honey</a></h4>
                                                <ul>
                                                    <li>Blueberry</li>
                                                    <li>Honey</li>
                                                    <li>Butter</li>
                                    ...
                                    <div class="col-xl-4 col-lg-6 col-md-6 mt-30">
                                        <div class="food-menu-style">
                                            <div class="thumb">
                                                <img src="assets/dessert-3.jpg" alt="Image Not Found">
                                                <div class="d-flex">
                                                    <div class="food-review">
                                                        <i class="fas fa-star"></i>
                                                        <span>4.8(6.7K)</span>
                                            ...
                                            <div class="info">
                                                <h4><a href="#">Cinnamon Rolls Muffin</a></h4>
                                                <ul>
                                                    <li>Cinnamon Flavor</li>
                                                    <li>Chocolate</li>
                                                    <li>Sweet</li>
                                                </ul>
                                                <a href="#" class="cart-btn-border"><i class="fas fa-shopping-cart"></i>
                                    ...
                                    <div class="col-xl-4 col-lg-6 col-md-6 mt-30">
                                        <div class="food-menu-style">
                                            <div class="thumb">
                                                <img src="assets/dessert-4.jpg" alt="Image Not Found">
                                                <div class="d-flex">
                                                    <div class="food-review">
                                                        <i class="fas fa-star"></i>
                                                        <span>5.0(3.5K)</span>
                                            ...
                                            <div class="info">
                                                <h4><a href="#">Delicious and Sweet Cupcake</a></h4>
                                                <ul>
                                                    <li>Chocolate</li>
                                                    <li>Cherry</li>
                                                    <li>Cream</li>
                                    ...
                                    <div class="col-xl-4 col-lg-6 col-md-6 mt-30">
                                        <div class="food-menu-style">
                                            <div class="thumb">
                                                <img src="assets/dessert-5.jpg" alt="Image Not Found">
                                                <div class="d-flex">
                                                    <div class="food-review">
                                                        <i class="fas fa-star"></i>
                                                        <span>4.6(5.7K)</span>
                                            ...
                                            <div class="info">
                                                <h4><a href="#">Tiramisu with cheese and chocolate</a></h4>
                                                <ul>
                                                    <li>4 chicken legs</li>
                                                    <li>Chili sauce</li>
                                                    <li>Soft Drinks</li>
                                    ...
                                    <div class="col-xl-4 col-lg-6 col-md-6 mt-30">
                                        <div class="food-menu-style">
                                            <div class="thumb">
                                                <img src="assets/dessert-6.jpg" alt="Image Not Found">
                                                <div class="d-flex">
                                                    <div class="food-review">
                                                        <i class="fas fa-star"></i>
                                                        <span>4.8(5.5K)</span>
                                            ...
                                            <div class="info">
                                                <h4><a href="#">Mixed Berry Ice Cream</a></h4>
                                                <ul>
                                                    <li>Mixed Berries</li>
                            ...
                            <div class="tab-pane fade" id="tab3" role="tabpanel" aria-labelledby="nav-id-3">
                                <div class="row">
                                    <div class="col-xl-4 col-lg-6 col-md-6 mt-30">
                                        <div class="food-menu-style">
                                            <div class="thumb">
                                                <img src="assets/dish-7.jpg" alt="Image Not Found">
                                                <div class="d-flex">
                                                    <div class="food-review">
                                                        <i class="fas fa-star"></i>
                                                        <span>4.9(5.7K)</span>
                                    ...
                                    <div class="col-xl-4 col-lg-6 col-md-6 mt-30">
                                        <div class="food-menu-style">
                                            <div class="thumb">
                                                <img src="assets/dish-8.jpg" alt="Image Not Found">
                                                <div class="d-flex">
                                                    <div class="food-review">
                                                        <i class="fas fa-star"></i>
                                                        <span>4.2(3.1K)</span>
                                            ...
                                            <div class="info">
                                                <h4><a href="#">Pangasius or Basa</a></h4>
                                                <ul>
                                                    <li>4 chicken legs</li>
                                                    <li>Chili sauce</li>
                                                    <li>Soft Drinks</li>
                                    ...
                                    <div class="col-xl-4 col-lg-6 col-md-6 mt-30">
                                        <div class="food-menu-style">
                                            ...
                                            <div class="info">
                                                <h4><a href="#">Spicy Stuffed Clams</a></h4>
                                                <ul>
                                                    <li>4 chicken legs</li>
                                                    <li>Chili sauce</li>
                                                    <li>Soft Drinks</li>
                                    ...
                                    <div class="col-xl-4 col-lg-6 col-md-6 mt-30">
                                        <div class="food-menu-style">
                                            ...
                                            <div class="info">
                                                <h4><a href="#">Special Cajun Red Crab</a></h4>
                                                <ul>
                                                    <li>4 chicken legs</li>
                                                    <li>Chili sauce</li>
                                                    <li>Soft Drinks</li>
                                    ...
                                    <div class="col-xl-4 col-lg-6 col-md-6 mt-30">
                                        <div class="food-menu-style">
                                            ...
                                            <div class="info">
                                                <h4><a href="#">Crustaceans such as lobsters</a></h4>
                                                <ul>
                                                    <li>4 chicken legs</li>
                                                    <li>Chili sauce</li>
                                                    <li>Soft Drinks</li>
                                    ...
                                    <div class="col-xl-4 col-lg-6 col-md-6 mt-30">
                                        <div class="food-menu-style">
                                            ...
                                            <div class="info">
                                                <h4><a href="#">The cephalopod mollusks</a></h4>
                                                <ul>
                                                    <li>4 chicken legs</li>
                                                    <li>Chili sauce</li>
                                                    <li>Soft Drinks</li>
                            ...
                            <div class="tab-pane fade" id="tab4" role="tabpanel" aria-labelledby="nav-id-4">
                                <div class="row">
                                    <div class="col-xl-4 col-lg-6 col-md-6 mt-30">
                                        <div class="food-menu-style">
                                            <div class="thumb">
                                                <img src="assets/drinks-1.jpg" alt="Image Not Found">
                                                <div class="d-flex">
                                                    <div class="food-review">
                                                        <i class="fas fa-star"></i>
                                                        <span>4.9(5.7K)</span>
                                            ...
                                            <div class="info">
                                                <h4><a href="#">Cabernet Sauvignon</a></h4>
                                                <ul>
                                                    <li>Lemon</li>
                                                    <li>Mint</li>
                                                    <li>Soft Drinks</li>
                                    ...
                                    <div class="col-xl-4 col-lg-6 col-md-6 mt-30">
                                        <div class="food-menu-style">
                                            <div class="thumb">
                                                <img src="assets/drinks-2.jpg" alt="Image Not Found">
                                                <div class="d-flex">
                                                    <div class="food-review">
                                                        <i class="fas fa-star"></i>
                                                        <span>4.2(3.1K)</span>
                                            ...
                                            <div class="info">
                                                <h4><a href="#">Americano Coffee</a></h4>
                                                <ul>
                                                    <li>Coffee</li>
                                                    <li>Chili sauce</li>
                                                    <li>Soft Drinks</li>
                                    ...
                                    <div class="col-xl-4 col-lg-6 col-md-6 mt-30">
                                        <div class="food-menu-style">
                                            <div class="thumb">
                                                <img src="assets/drinks-3.jpg" alt="Image Not Found">
                                                <div class="d-flex">
                                                    <div class="food-review">
                                                        <i class="fas fa-star"></i>
                                                        <span>4.8(6.7K)</span>
                                            ...
                                            <div class="info">
                                                <h4><a href="#">Hot chocolate Shake</a></h4>
                                                <ul>
                                                    <li>4 chicken legs</li>
                                                    <li>Chili sauce</li>
                                                    <li>Soft Drinks</li>
                                    ...
                                    <div class="col-xl-4 col-lg-6 col-md-6 mt-30">
                                        <div class="food-menu-style">
                                            <div class="thumb">
                                                <img src="assets/drinks-4.jpg" alt="Image Not Found">
                                                <div class="d-flex">
                                                    <div class="food-review">
                                                        <i class="fas fa-star"></i>
                                                        <span>5.0(3.5K)</span>
                                            ...
                                            <div class="info">
                                                <h4><a href="#">Watermelon Juice</a></h4>
                                                <ul>
                                                    <li>4 chicken legs</li>
                                                    <li>Chili sauce</li>
                                                    <li>Soft Drinks</li>
                                    ...
                                    <div class="col-xl-4 col-lg-6 col-md-6 mt-30">
                                        <div class="food-menu-style">
                                            <div class="thumb">
                                                <img src="assets/drinks-5.jpg" alt="Image Not Found">
                                                <div class="d-flex">
                                                    <div class="food-review">
                                                        <i class="fas fa-star"></i>
                                                        <span>4.6(5.7K)</span>
                                            ...
                                            <div class="info">
                                                <h4><a href="#">Seared Scallops with Butter</a></h4>
                                                <ul>
                                                    <li>4 chicken legs</li>
                                                    <li>Chili sauce</li>
                                                    <li>Soft Drinks</li>
                            ...
                            <?php $__currentLoopData = $food_gallery; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $food_gallery): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <div class="swiper-slide">
                                    <div class="gallery-item position-relative">
                                        <img src="/food_gallery/<?php echo e($food_gallery->image); ?> " class="img-fluid"
                                            alt="Image Not Found">
                                        <div
                                            ...
                                            <h4><a href="#">Double-Stack Chicken</a></h4>
                                        </div>
                                    </div>
                                </div>
            ...
            <div class="row d-flex">
                ...
                <div class="col-md-6 makereservation p-4 p-md-5">
                    <div class="heading-section mb-5">
                        ...
                        <?php if(session()->has('reservation_message')): ?>
                        <div class="alert alert-success">
                            <?php echo e(session()->get('reservation_message')); ?>
        ...
        <div class="container">
            <div class="row add-background">
                ...
                <div class="col-lg-6">
                    ...
                    <form action="<?php echo e(url('contact')); ?>" method="post" id="dreamit-form">
                        <?php echo csrf_field(); ?>
...
</html><?php /**PATH /Users/mithilarahman/Desktop/LARAVEL/Hotel_Managment/resources/views/home/restaurant.blade.php ENDPATH**/ ?>